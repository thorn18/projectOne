...
exports.updateUserClaims = exports.updateUserRemaining = exports.login = exports.User = void 0;
var log_1 = __importDefault(require("../log"));
var user_service_1 = __importDefault(require("./user.service"));
var User = /** @class */ (function () {
    function User(name, password, supervisor, role, remainingClaim, myClaims, myReviews) {
        this.name = name;
...
exports.login = login;
function updateUserRemaining(user) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user_service_1.default.updateUserRemaining(user).then(function (success) {
...
exports.updateUserRemaining = updateUserRemaining;
function updateUserClaims(user) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user_service_1.default.updateUserClaims(user).then(function (success) {
                        log_1.default.info('user updated successfully');
                    }).catch(function (error) {
                        log_1.default.warn('user not updated');
                    })];
